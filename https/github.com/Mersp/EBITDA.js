...
(function() {
	var proizvodLVL = 5; //коэффициент производа
	...
	var income = (out * out_price - salary * hours) * proizvodLVL; 

	for (var i = 0, l = a_in.length; i < l; i++) 
		income -= (a_in[i] * a_in_price[i]  * proizvodLVL);
	...
	c[2].parentNode.insertBefore(c_new, c[6]);
